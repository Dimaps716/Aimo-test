...
"""
Starts  the server running. Handles requests.
"""

import json
from hashlib import md5
from bottle import run, route, post, get, getstatic_file, request, hook, HTTPResponse
from bottle_cors_plugin import cors_plugin
from peewee import *
from playhouse.shortcuts import model_to_dict
from models import User, Notes, create_tables
from token_util import generate_token, validate_token, clear_token
...
@get('/list-user-notes/<user_id>/<token>', method="GET")
